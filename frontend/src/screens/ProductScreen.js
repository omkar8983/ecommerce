...
const ProductScreen = ({ history, match }) => {
  ...
  return (
    <>
      { showBulkModel ? <BulkOrderModal qty={qty} setQtyHandler={setQtyHandler} product_id={match.params.id}/> : null}
                ...
                <Row>
                  ...
                  <div
                      ...
                      <ListGroup.Item>
                        How to use Product:
                  <div
                          className="htup-content"
                          dangerouslySetInnerHTML={{ __html: product.htup }}
                        ></div>
                      </ListGroup.Item>
                    </ListGroup>
                  </Col>
